...
exports.writeJSHELP = function (text, encoding, name) {
  ...
  writeFileSync(name + '.jshlp', fullSequence, function () {
    process.stdout.write('Woohoo!')
  })
}

exports.readJSHELP = function (filename) {
  fullSequence = readFileSync('./helptopics/' + filename + '.jshlp', function (data) {
    return data
  })
  let headers = true;
  let byte;
...
*/
  switch (fullSequence[0]) {
    case 0: {
      decodedEncoding = 'latin1';
      break;
    };
  case 1: {
    decodedEncoding = 'ansi';
    break;
  };
  case 2: {
  ...
  case 4: {
    decodedEncoding = 'ucs2';
    break;
  };
  case 5: {
    decodedEncoding = 'utf16le';
    break;
  };
  default: {
    decodedEncoding = 'utf8';
