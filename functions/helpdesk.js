...
const { readJSHELP } = require('./jshlp')


initializeFiles = function() {
let helpList = readdirSync('./helptopics/',['utf8',false],function(err,files) {if(err){process.stdout.write(err.toString())}; return files})
let helpListTMP = []
